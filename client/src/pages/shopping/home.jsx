...
export const ShoppingHome = () => {
  ...
  const productList = useSelector(shopProductsSelector);
  const productDetails = useSelector(shopProductDetailsSelector);

  const featureImageList = useSelector(featureImagesSelector);
  ...
  function handleAddtoCart(getCurrentProductId) {
    dispatch(
      ...
      if (data?.payload?.success) {
        dispatch(getCartItems({ userId: user?.id }));
        Notification({
