...
import { createOrder } from "../../store/slices/shopSlice";
export const ShoppingCheckout = () => {
  ...
  const approvalURL = useSelector(shopApprovalURLSelector);
  ...
  function handleInitiatePaypalPayment() {
    ...
    dispatch(createOrder({ values: orderData })).then((data) => {
